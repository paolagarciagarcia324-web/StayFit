...
$planNutricional = $planNutricional ?? null; // Plan nutricional
$comidas = $comidas ?? []; // Comidas asignadas
...
<head>
    ...
    <title>Nutrición Institucional | StayFit</title> <!-- Título -->
...
<div class="cliente-wrapper">
    ...
    <main class="content">
        ...
        <section class="page-header">
            <h1>Nutrición institucional</h1>
            <p>Consulta tus recomendaciones nutricionales y comidas asignadas dentro del programa institucional.</p>
        </section>
