...
class AuthController
{
    ...
    public function __construct()
    {
        ...
        $this->usuarioModel = new UsuarioModel($this->db); // Instancia el modelo
    }
    ...
    public function login()
    {
        ...
        $passwordHash = $usuario['password'] ?? $usuario['password_hash']; // Obtiene contraseña cifrada
        ...
        $_SESSION['usuario_id'] = $usuario['id']; // Guarda ID del usuario
    ...
    {
        $rol = strtolower($rol); // Normaliza el rol
