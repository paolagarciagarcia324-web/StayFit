...
class ProgramaModel extends StayFitModel
{
    protected string $table = 'programa';
    protected string $primaryKey = 'id_programa';
    protected array $fillable = ['id_plan', 'nombre', 'descripcion', 'objetivo', 'nivel', 'activo'];
