...
$progresos = $progresos ?? []; // Historial de progreso
...
<head>
    ...
    <title>Progreso Institucional | StayFit</title> <!-- Título -->
...
<div class="cliente-wrapper">
    ...
    <aside class="sidebar">
        ...
        <a class="active" href="../../controllers/clienteIns/progresoController.php">Progreso</a>
