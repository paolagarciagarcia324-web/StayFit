...
class ClienteInsNotificacionController
{
    ...
    public function index()
    {
        ...
        require_once __DIR__ . '/../../views/clienteIns/notificaciones.php'; // Carga vista
    }
...
$controller = new ClienteInsNotificacionController(); // Crea controlador
